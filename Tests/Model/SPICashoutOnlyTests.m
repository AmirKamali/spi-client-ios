...
-(void)testRequestPurchaseV2_adds_all_fields_to_dataDictionary {
    ...
    SPIPurchaseRequest *request = [SPIPurchaseHelper createPurchaseRequestV2:posRefId purchaseAmount:amountCents tipAmount:tipamount cashAmount:cashamount promptForCashout:promptForCash];
