...
-(void)testClient_CanInitiate_Purchase_request{
    ...
    [client initiatePurchaseTxV2:@"test" purchaseAmount:10 tipAmount:0 cashoutAmount:0 promptForCashout:false completion:^(SPIInitiateTxResult *result) {
...
-(void)testClient_CanHandle_Purchase_response{
    ...
    XCTAssertTrue([client.state.txFlowState.displayMessage isEqualToString:@"Purchase transaction ended."]);
}
@end
